...
| Nguồn | Chưa chốt pin và mạch ổn áp; thử motor TT ở 5–6 V theo đúng mã hàng | Cả hai: đo điện áp/dòng khi khởi động và tải, nối chung GND, bố trí decoupling |
...
- **Nguồn:** chốt pin sau khi biết linh kiện thật. Dùng điện áp motor ban đầu 5–6 V để thử trên giá đỡ; không lấy pin 2S 8,4 V khi đầy để cấp thẳng cho một TT chỉ ghi 3–6 V. Nếu dùng 2S, chọn bộ hạ áp phù hợp **dòng khởi động/kẹt đo được của hai motor** và nguồn logic theo board; không suy ra khả năng tải liên tục từ nhãn “3 A” của module giá rẻ. Chung GND, nhưng tách đường cấp motor và logic theo sơ đồ thực.
