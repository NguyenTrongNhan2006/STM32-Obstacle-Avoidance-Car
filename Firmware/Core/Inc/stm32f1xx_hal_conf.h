/*
 * stm32f1xx_hal_conf.h — dan xuat tu stm32f1xx_hal_conf_template.h cua ST
 * (ThirdParty/STM32F1xx_HAL_Driver/Inc/). Giu nguyen copyright ST o duoi.
 *
 ...
 * dieu kien de ra 72 MHz qua PLL x9.
 *
 * TICK_INT_PRIORITY con de nguyen 0x0F o day. Moc A3 se override HAL_InitTick()
 * vi kernel so huu SysTick — HAL nhan tick qua vApplicationTickHook() ->
 * HAL_IncTick(), khong tu cau hinh SysTick nua.
 */
/**
  ******************************************************************************
