...
#define SAFETY_BIT_TASK_FAULT ((EventBits_t)1U << 3)
#define SAFETY_INHIBIT_MASK (SAFETY_BIT_STOP | SAFETY_BIT_SENSOR_FAULT | \
                             SAFETY_BIT_TILT_FAULT | SAFETY_BIT_TASK_FAULT)
